        ...
        <div class="col-md-4 order-md-2 mb-4">
         ...
         <!--Your Cart---->  
                       ...
                       @php
                           $total = 0;
                       @endphp
                    @foreach ($cart_data as $key => $scart_data) 
            
                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                            <div>
                                <h6 class="my-0">{{ $scart_data->name }}</h6>
                                <small class="text-muted">{{ $scart_data->description }}</small>
                            </div>
                            <span class="text-muted">{{ $scart_data->price }}</span>
                        </li>
                                @php
                                  $total = $total + $scart_data->price;
                                @endphp
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="cus_address" id="address" placeholder="1234 Main St"
                ...
                <hr class="mb-4">
                <button class="btn btn-primary btn-lg btn-block" name="submit" type="submit">Continue to checkout (Hosted)</button>
            </form>
        </div>
    </div>
